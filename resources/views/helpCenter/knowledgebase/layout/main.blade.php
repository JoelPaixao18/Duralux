...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="a{{url('ssets/vendors/css/select2.min.css')}}">
...
<body>
    @include('helpCenter.knowledgebase.parcial.header')
    @include('helpCenter.knowledgebase.parcial.menu')
    @include('helpCenter.knowledgebase.parcial.theme')

    <div>
        @yield('container-help-center')
    </div>

    @include('helpCenter.knowledgebase.parcial.footer')
    <!--! BEGIN: Vendors JS !-->
